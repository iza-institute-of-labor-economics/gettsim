...
TYPES_INPUT_VARIABLES = {
    ...
    "sozialversicherung__rente__altersrente__krankheitszeiten_ab_16_bis_24_m": float,
    "sozialversicherung__rente__altersrente__mutterschutzzeiten_m": float,
    ...
    "sozialversicherung__rente__altersrente__schulausbildung_m": float,
    ...
    "sozialversicherung__rente__altersrente__zeiten_geringfügiger_beschäftigung_m": float,
