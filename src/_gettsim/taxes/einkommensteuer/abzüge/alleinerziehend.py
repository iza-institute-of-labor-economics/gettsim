...
def alleinerziehend_betrag_y_pauschal(
    ...
    if einkommensteuer__alleinerziehend_sn:
        out = eink_st_abzuege_params["alleinerziehend_freibetrag"]
    else:
        out = 0.0
...
def alleinerziehend_betrag_y_nach_kinderzahl(
    ...
    """
    betrag_y = (
        eink_st_abzuege_params["alleinerziehend_freibetrag"]
        + (kindergeld__anzahl_ansprüche_sn - 1)
        * eink_st_abzuege_params["alleinerziehend_freibetrag_zusatz"]
    )
    if einkommensteuer__alleinerziehend_sn:
        out = betrag_y
    else:
