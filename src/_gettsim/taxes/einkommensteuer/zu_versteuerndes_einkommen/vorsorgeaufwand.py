...
def _vorsorgeaufw_y_sn_bis_2004(
    ...
    return vorsorgeaufw_y_sn_bis_2004(
        ...
        ges_krankenv_beitr_arbeitnehmer_y_sn=ges_krankenv_beitr_arbeitnehmer_y_sn,
        ges_rentenv_beitr_arbeitnehmer_y_sn=ges_rentenv_beitr_arbeitnehmer_y_sn,
...
def vorsorgeaufw_y_sn_bis_2004(
    ...
    multiplikator1 = max(
        (
            (ges_rentenv_beitr_arbeitnehmer_y_sn + ges_krankenv_beitr_arbeitnehmer_y_sn)
            - _vorsorgeaufw_vom_lohn_y_sn_bis_2004
        ),
        0.0,
    )
