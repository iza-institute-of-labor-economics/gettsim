...
def elterngeld_anspruch(
    ...
    alleinerz: bool,
    zu_verst_eink_mit_kinderfreib_y_sn: float,
    ...
    zu_verst_eink_mit_kinderfreib_uy_sn
        See :func:`zu_verst_eink_mit_kinderfreib_y_sn`
    elternzeit_anspruch
    ...
    out = ( 
        ...
        and ((alleinerz == 'true' and zu_verst_eink_mit_kinderfreib_y_sn <= elterngeld_params["max_einkommen_vorj_allein"])
                or (zu_verst_eink_mit_kinderfreib_y_sn <= elterngeld_params["max_einkommen_vorj_zsm"]))
