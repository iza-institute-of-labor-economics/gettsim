...
def wohngeld_nach_vermög_check_m_hh(
    ...
    if vermögen_bedürft_bg <= (
        ...
        + (wohngeld_params["vermögensfreibetrag_pers"] * (größe_hh - 1))
    ):
...
def arbeitsl_geld_2_vermög_freib_bg_bis_2022(
    ...
    out = (
        ...
        + größe_hh * arbeitsl_geld_2_params["vermögensfreibetrag_austattung"]
    )
    return out
...
def _arbeitsl_geld_2_vermög_freib_karenzz_bg(
    ...
    out = params["während_karenzzeit"] + (größe_hh - 1) * params["normaler_satz"]
...
def arbeitsl_geld_2_vermög_freib_bg_ab_2023(
    ...
    if bürgerg_bezug_vorj:
        out = größe_hh * params["normaler_satz"]
    else:
