...
@policy_info(start_date="2011-01-01", change_name="arbeitsl_geld_2_kindersatz_m_bg")
...
@policy_info(start_date="2011-01-01", change_name="arbeitsl_geld_2_regelsatz_m_bg")
