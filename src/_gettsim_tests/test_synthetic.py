...
def synthetic_data_spec_variables():
    df = create_synthetic_data(
        ...
        specs_constant_over_households={
            ...
            "basic_inputs__einkommensteuer__einnahmen__bruttolohn_m": [1000, 2000, 0],
        },
    )
    return df
...
def synthetic_data_spec_heterogeneous_married():
    df = create_synthetic_data(
        ...
        specs_heterogeneous={
            "basic_inputs__einkommensteuer__einnahmen__bruttolohn_m": [
    ...
    [
        ...
        (
            ...
            None,
            {
                ...
                "basic_inputs__einkommensteuer__einnahmen__bruttolohn_m": [[300, 200]],
            },
            pytest.raises(ValueError, match="Length of"),
        ),
    ],
