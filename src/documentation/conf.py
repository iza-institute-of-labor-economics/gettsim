...
project = u"IZA Dynamic Policy Simulation Model"
copyright = u"2019-, Janos Gabler, Hans-Martin von Gaudecker, Eric Sommer"
...
latex_documents = [
    (
        ...
        "Documentation of the IZA Dynamic Policy Simulation Model project",
        "Janos Gabler, Hans-Martin von Gaudecker, Eric Sommer",
        "manual",
    )
]
