...
- Reformen (z.b. 'GRUNDEK') werden in settings spezifiziert und per if-Bedingung in tax_transfer.py geschaltet.
...
- Die Steuer-Transfer-Parameter seit 1984 (Steuertarife, Transferhöhen etc.) liegen in /data/params/params.xlsx . Dort steht auch die entsprechende Gesetzesgrundlage. In tax_transfer.py werden die Parameter für das entsprechende Jahr in das dictionary 'tb' geladen.
