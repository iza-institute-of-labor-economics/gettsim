...
DESCRIPTION = (
    ...
    "complex dynamic programming models to extremely detailed microsimulation studies."
)
README = Path("README.rst").read_text()
PROJECT_URLS = {
    "Bug Tracker": "https://github.com/iza-institute-of-labor-economics/gettsim/issues",
    "Documentation": "https://gettsim.readthedocs.io/en/latest",
...
setup(
    ...
    url="https://gettsim.readthedocs.io/en/latest/",
