...
def test_tax_sched(
    ...
    df["zu_verst_eink_kein_kinder_fb_tu"] = (
        df["zu_verst_eink_kein_kinder_fb"].groupby(df["tu_id"]).transform("sum")
    )

    df["zu_verst_eink_kinder_fb_tu"] = (
        df["zu_verst_eink_kinder_fb"].groupby(df["tu_id"]).transform("sum")
    )
