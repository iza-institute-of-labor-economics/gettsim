def sum_wohngeld_m_arbeitsl_geld_2_eink(
    sum_basis_arbeitsl_geld_2_eink, _wohngeld_basis_hh_vermögens_check
):
    return sum_basis_arbeitsl_geld_2_eink + _wohngeld_basis_hh_vermögens_check


def sum_kinderzuschlag_arbeitsl_geld_2_eink(
    sum_basis_arbeitsl_geld_2_eink, _kinderzuschlag_m_vermögens_check
):
    return sum_basis_arbeitsl_geld_2_eink + _kinderzuschlag_m_vermögens_check
...
def arbeitsl_geld_2_m_basis(
    _regelbedarf_m_vermögens_check, sum_basis_arbeitsl_geld_2_eink
):
    return (_regelbedarf_m_vermögens_check - sum_basis_arbeitsl_geld_2_eink).clip(
        lower=0
    )
