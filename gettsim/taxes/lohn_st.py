...
def lohn_st(
    ...
    grenze_1 = eink_st_params["lohn_st_einkommensgrenzen"]["threshold"][0]
    grenze_2 = eink_st_params["lohn_st_einkommensgrenzen"]["threshold"][1]
    grenze_3 = eink_st_params["lohn_st_einkommensgrenzen"]["threshold"][2]
