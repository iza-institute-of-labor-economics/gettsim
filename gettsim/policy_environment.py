...
from gettsim.taxes.zu_verst_eink.freibetraege import eink_st_sonderausgaben_ab_2012_tu
from gettsim.taxes.zu_verst_eink.freibetraege import eink_st_sonderausgaben_bis_2011_tu
...
def load_reforms_for_date(date):
    ...
    if year > 2011:
        functions["eink_st_sonderausgaben_tu"] = eink_st_sonderausgaben_ab_2012_tu
    else:
        functions["eink_st_sonderausgaben_tu"] = eink_st_sonderausgaben_bis_2011_tu
