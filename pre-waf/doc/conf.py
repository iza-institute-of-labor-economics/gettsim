...
project = u"IZA-Dyn-Mod-Py"
copyright = u"2018-, Eric Sommer, Janos Gabler, Hans-Martin von Gaudecker"
...
latex_documents = [(
    ...
    "Documentation of the IZA-Dyn-Mod-Py project",
    "Eric Sommer, Janos Gabler, Hans-Martin von Gaudecker",
    "manual"
)]
